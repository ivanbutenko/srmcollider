...
class_<Rangetree_Q1_RT, boost::shared_ptr<Rangetree_Q1_RT> >("Rangetree_Q1_RT",init<>())
        .def("create",&Rangetree_Q1_RT::create )
        .staticmethod("create")
        .def("new_rangetree",&Rangetree_Q1_RT::new_rangetree)
        .def("create_tree",&Rangetree_Q1_RT::create_tree)
        .def("query_tree",&Rangetree_Q1_RT::query_tree)
    ;
